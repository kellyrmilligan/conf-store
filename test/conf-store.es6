...
describe('load()', () => {
    ...
    it('fails on invalid tree', (done) => {
        ...
        expect(() => {
          store.load({ $b: 3 })
        }).to.throw(Error, 'Unknown $ directive $b');
...
describe('validate()', () => {
    ...
    it('fails on Error node', (done) => {
        ...
        const err = ConfStore.validate({ key: new Error() });
        console.log(err)
    ...
    it('fails on empty filter', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: '' } });
    ...
    it('fails on non-string filter', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 3 } });
    ...
    it('fails on invalid filter', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: '4$' } });
    ...
    it('fails on invalid default', (done) => {
        ...
        const err = ConfStore.validate({ key: { $default: { $b: 5 } } });
    ...
    it('fails on unknown directive', (done) => {
        ...
        const err = ConfStore.validate({ key: { $unknown: 'asd' } });
    ...
    it('fails on invalid child node', (done) => {
        ...
        const err = ConfStore.validate({ key: { sub: { $b: 5 } } });
        expect(err.message).to.equal('Unknown $ directive $b');
    ...
    it('fails on invalid value node', (done) => {
        ...
        const err = ConfStore.validate({ key: { $value: { $b: 5 } } });
        expect(err.message).to.equal('Unknown $ directive $b');
    ...
    it('fails on mix of value and other criteria', (done) => {
        ...
        for (let i = 0; i < keys.length; ++i) {
            ...
            const err = ConfStore.validate(node);
    ...
    it('fails on default value without a filter', (done) => {
        ...
        const err = ConfStore.validate({ key: { $default: 1 } });
    ...
    it('fails on filter without any value', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: '1' } });
    ...
    it('fails on filter with only default', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 'a', $default: 1 } });
    ...
    it('fails on non-array range', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 'a', $range: {}, $default: 1 } });
    ...
    it('fails on non-object range array element', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 'a', $range: [5], $default: 1 } });
    ...
    it('fails on range array element with non-number limit', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 'a', $range: [{ limit: 'a' }], $default: 1 } });
    ...
    it('fails on out of order range array elements', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 'a', $range: [{ limit: 11, value: 2 }, { limit: 10, value: 6 }], $default: 1 } });
    ...
    it('fails on range array element missing value', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 'a', $range: [{ limit: 1 }], $default: 1 } });
    ...
    it('fails on range array element with invalid value', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 'a', $range: [{ limit: 1, value: { $b: 5 } }], $default: 1 } });
        expect(err.message).to.equal('Unknown $ directive $b');
    ...
    it('fails on range without a filter', (done) => {
        ...
        const err = ConfStore.validate({ key: { $range: [{ limit: 1, value: 1 }] } });
    ...
    it('fails on range with non-ranged values', (done) => {
        ...
        const err = ConfStore.validate({ key: { $filter: 'a', $range: [{ limit: 1, value: 1 }], a: 1 } });
    ...
    it('fails on invalid id', (done) => {
        ...
        const err = ConfStore.validate({ key: 5, $id: 4 });
    ...
    it('fails on empty id', (done) => {
        ...
        const err = ConfStore.validate({ key: 5, $id: null });
        expect(err.message).to.equal('Id value must be a non-empty string');
        expect(err.path).to.equal('/');
        done();
    });
    ...
    it('returns null with null as the node', (done) => {
        ...
        const err = ConfStore.validate(null);
    ...
    it('returns null with undefined as the node', (done) => {
        ...
        const err = ConfStore.validate(undefined);
        expect(err).to.equal(null);
        done();
    });
    ...
    it('fails on node that is a Date object', (done) => {
        ...
        const err = ConfStore.validate(new Date());
...
it('accepts a document object in the constructor', (done) => {
    ...
    const load = ConfStore.prototype.load;
